...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('.testimonials2').each(function (index, value) {
            var valueObj = $(value),
                isRTL = $('html').attr('dir') === 'rtl', // RTL kontrolü
            ...
            if (isRTL) {
                valueObj.find('.item .cont').css({ 'right': devideWidth, 'left': 'auto' });
            } else {
                valueObj.find('.item .cont').css({ 'left': devideWidth, 'right': 'auto' });
            }
